<template>
  <div class="networkmodulestyle" :style="clickStyle">
    <!-- 标题 -->
    <h2>{{ datas.text }}</h2>
    <!-- 名称 -->
    ...
    <div class="card header">
      ...
      <div style="margin-top: 20px;">
        ...
        <el-select v-model="datas.is_image" placeholder="请选择字段名称">
          ...
          <el-option label="插入图片且图片必填" value="1"
            ></el-option
          >
          <el-option label="插入图片且图片选填" value="2"
            ></el-option
          >
        </el-select>
      </div>
      ...
      <el-form :model="item" :rules="sxRules" label-position="top" ref="sxList">
        ...
        <el-form-item label="筛选类型(类型之间用^隔开) " prop="select_value">
          <el-input
            ...
            autocomplete="off"
            @input="handlesxtype(item)"
            placeholder="例：男^女"
            :disabled="routePath == '/moduleSubmit' ? true : false"
          >
          </el-input>
        </el-form-item>
        ...
        >
          <el-select
            ...
            placeholder="请选择字段名称"
            @change="columnChange($event, item)"
          >
            <el-option
              v-for="(item, index) in checkTextList"
              :key="index"
            ...
            <div class="card folding">
              ...
              <div class="card add-search">
                <div class="switch-box">
                  ...
                  <div
                    class="switch"
                    :class="{ isOn: datas.is_fold }"
                    @click="chosenSwitchThree"
                  >
          ...
          <div class="card">
            <el-form label-position="top">
              <el-form-item label="备注" style="margin-bottom: 0">
                <el-input v-model="datas.remark" placeholder="不填写则不备注">
                </el-input>
              </el-form-item>
            </el-form>
          </div>
...
export default {
  ...
  methods: {
    ...
    // 获取vuex中方法
    ...mapMutations('network', ['SETNETWORK']),
    handleCheck(item) {
