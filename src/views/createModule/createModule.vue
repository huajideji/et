<template>
  <div class="create">
    <el-row>
      ...
      <el-col :span="7">
        <RecentTable :topic-data="topicData" />
...
<script>
import ModuleTable from './components/moduleTable/index.vue'
import LatestNews from './components/latestNews/index.vue'
import RecentTable from './components/recentTable/index.vue'
...
export default {
  ...
  methods: {
    async getList() {
      ...
      const res = await this.$api.getModuleTableList(params)
